...
class Wall(sprite.Sprite):
    ...
    def draw_wall(self):
        window.blit(self.image, (self.rect.x, self.rect.y))
happy1 = Wall(154, 205, 50, 100, 20, 410, 10)
happy2 = Wall(154, 205, 50, 100, 20, 10, 380)
happy3 = Wall(154, 205, 50, 400, 100, 10, 380)
happy4 = Wall(154, 205, 50, 200, 100, 10, 380)
happy5 = Wall(154, 205, 50, 300, 25, 10, 380)
